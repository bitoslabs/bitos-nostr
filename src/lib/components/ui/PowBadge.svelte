...
>
	<svg class="size-3 shrink-0 text-[var(--ui-color-primary-500)]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
		<path d="M12 1 3 6v6c0 5 3.8 9.7 9 11 5.2-1.3 9-6 9-11V6l-9-5Z" opacity=".25" />
		<path d="M12 2 4 6.2v5.6c0 4.5 3.4 8.7 8 9.9 4.6-1.2 8-5.4 8-9.9V6.2L12 2Zm-1 14-4-4 1.4-1.4L11 13.2l4.6-4.6L17 10l-6 6Z" />
	</svg>
	{#if !compact}
